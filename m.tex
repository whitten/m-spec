...
\begin{document}
    ...
    programs become difficult to reason about for humans and computers alike, and maintaining a compliant, feature-rich software stack becomes exponentially difficult.

    Simplicity is to reason about a programming language;
